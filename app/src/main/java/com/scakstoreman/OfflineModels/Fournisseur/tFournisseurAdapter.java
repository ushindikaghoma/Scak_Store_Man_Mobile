...
public class tFournisseurAdapter extends BaseAdapter {

    Context context;
    public ArrayList<tFournisseur> arrayListFournisseur;

    LayoutInflater inflater;

    public tFournisseurAdapter(Context context) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        holder.textView_numero_compte.setText(this.arrayListFournisseur.get(i).getNumCompte()+"");
    ...
    public void setList(List<tFournisseur> list) {
