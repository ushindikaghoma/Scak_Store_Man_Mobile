...
public class SplashScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tPanierAttente.createSqlTable(DatabaseHandler.getInstance(this).getWritableDatabase());
        tOperation.createSqlTable(DatabaseHandler.getInstance(this).getWritableDatabase());
        tOperationAttente.createSqlTable(DatabaseHandler.getInstance(this).getWritableDatabase());
